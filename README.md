...
🌐 **Live Portfolio**
https://sravantummalapalli.vercel.app/
...
Clean and minimal interface designed with usability and aesthetics in mind.

### 🌗 Dark / Light Mode

Allows users to switch between dark and light themes for better readability and comfort.

### 📱 Fully Responsive Design

Optimized to work seamlessly across:
...
Interactive and engaging animations that enhance the browsing experience.

### 🧭 Smooth Navigation

Well-structured sections with intuitive navigation.
...
Optimized build configuration ensures quick load times and efficient performance.
...
* **GitHub**
  https://github.com/SravanTummalapalli
